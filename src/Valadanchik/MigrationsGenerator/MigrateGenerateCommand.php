...
use Valadanchik\MigrationsGenerator\Generators\SchemaGenerator;
use Valadanchik\MigrationsGenerator\Syntax\AddToTable;
use Valadanchik\MigrationsGenerator\Syntax\DroppedTable;
use Valadanchik\MigrationsGenerator\Syntax\AddForeignKeysToTable;
use Valadanchik\MigrationsGenerator\Syntax\RemoveForeignKeysFromTable;
...
class MigrateGenerateCommand extends GeneratorCommand {
	...
	/**
	 * @var \Valadanchik\MigrationsGenerator\Generators\SchemaGenerator
	 */
