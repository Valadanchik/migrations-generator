...
[![Build Status](https://travis-ci.org/Valadanchik/migrations-generator.svg)](https://travis-ci.org/Valadanchik/migrations-generator)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/Valadanchik/migrations-generator/badges/quality-score.png?s=41d919c6d044749cb8575bb936efbddc4cebc0d8)](https://scrutinizer-ci.com/g/Valadanchik/migrations-generator/)
[![Latest Stable Version](https://poser.pugx.org/valadanchik/migrations-generator/v/stable.png)](https://packagist.org/packages/valadanchik/migrations-generator)
[![Total Downloads](https://poser.pugx.org/valadanchik/migrations-generator/downloads.png)](https://packagist.org/packages/valadanchik/migrations-generator)
[![License](https://poser.pugx.org/valadanchik/migrations-generator/license.png)](https://packagist.org/packages/valadanchik/migrations-generator)

Generate Laravel Migrations from an existing database, including indexes and foreign keys!

## Upgrading to Laravel 5.4

Please note that the Laravel 4 Generator edits have been moved to `https://github.com/valadanchik/Laravel-4-Generators.git` to update compatibility.
...
```bash
composer require --dev "valadanchik/migrations-generator"
```
...
Valadanchik\MigrationsGenerator\MigrationsGeneratorServiceProvider::class,
```
...
public function register()
{
    if ($this->app->environment() !== 'production') {
        ...
        $this->app->register(\Valadanchik\MigrationsGenerator\MigrationsGeneratorServiceProvider::class);
    }
    // ...
}
```
...
```bash
composer require --dev "valadanchik/migrations-generator:~1.3.0"
```
...
'Valadanchik\MigrationsGenerator\MigrationsGeneratorServiceProvider',
```
